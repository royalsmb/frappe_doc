...
# 		from erpnext.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import SubcontractingReceiptItem
# 		from erpnext.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import SubcontractingReceiptSuppliedItem
...
# 			if item.subcontracting_order:
# 				sc = frappe.get_doc("Subcontracting Order", item.subcontracting_order)
# 				sc_items = {i.name: i for i in sc.items}
# 				#get the item qty
# 				actual_qty = sc_items[item.subcontracting_order_item].qty
# 				# item.rejected_qty = actual_qty - item.qty
# 				item.amount = flt(item.qty) * flt(item.rate)
